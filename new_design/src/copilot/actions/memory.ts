...
export const memoryCommands: CommandDef[] = [
  ...
  {
    name: "memory.get",
    description: "Get one memory by id, including metadata and archived status.",
    scope: "server",
    routes: ROUTES,
    parameters: {
      type: "object",
  ...
  {
    name: "memory.update",
    description: "Modify a memory's content, namespace, category, tags, or metadata. Saves the old content to memory_versions.",
    scope: "server",
    routes: ROUTES,
    parameters: {
      type: "object",
  ...
  },
  {
    ...
    description: "List saved historical versions for a memory.",
    scope: "server",
    routes: ROUTES,
    parameters: {
      type: "object",
  ...
  {
    name: "memory.session.rename",
    description: "Rename a memory session marker.",
    scope: "server",
    routes: ROUTES,
    parameters: {
      type: "object",
      properties: { slug: { type: "string" }, namespace: { type: "string" }, name: { type: "string" } },
      required: ["name"],
    },
  },
  {
    name: "memory.session.update",
    description: "Update a memory session title or description.",
    scope: "server",
    routes: ROUTES,
    parameters: {
      type: "object",
