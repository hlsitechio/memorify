...
const CATALOG = [
  ...
  { kind: "openai_codex", name: "OpenAI Codex CLI",  tagline: "Coming soon", description: "OpenAI's terminal coding agent.",          icon: Sparkles, logo: "/logos/codex.png", tone: "text-emerald-400", featured: false },
