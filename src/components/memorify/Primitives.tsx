...
const groups = [
  ...
  },
  {
    ...
    tools: ["documents_add_from_url", "documents_search", "documents_view", "documents_list"],
    detail: ["full-text + pgvector", "source + chunk metadata", "memory + document results"],
    color: "blue",
  ...
  },
  {
    ...
    tools: ["whoami", "events_log", "events_list", "agent_token_create", "agent_token_revoke", "agent_token_list"],
