import { Home, Sparkles, Puzzle, Plug, Database, FileText, Image as ImageIcon, Mic, Table2, Lock, Activity, ScrollText, KeyRound, Settings, Server, type LucideIcon } from "lucide-react";
