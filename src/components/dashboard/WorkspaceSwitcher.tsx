  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start" side="bottom" className="w-64">
        ...
        <DropdownMenuItem onClick={selectUser} className="gap-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-[10px] text-muted-foreground truncate">main</div>
          </div>
          {activeId === userRowId && <Check className="h-3.5 w-3.5 text-primary" />}
        </DropdownMenuItem>
