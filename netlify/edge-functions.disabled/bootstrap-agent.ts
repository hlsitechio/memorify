  ...
  try {
    ...
    await sql(
      `INSERT INTO agent_tokens (workspace_id, agent_id, jti, token_hash, scopes, expires_at)
       VALUES ($1, $2, $3, $4, $5, $6)`,
      [workspaceId, agent_id, jti, tokenHash, VALID_BOOTSTRAP_SCOPES, null],
    );
    ...
    await sql(
      ...
      [
        ...
        agent_id,
        jti,
        JSON.stringify({ scopes: VALID_BOOTSTRAP_SCOPES, expires_at: null }),
      ],
    ).catch(() => {});
